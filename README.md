...
| 3 | Merge Overlapping Subintervals | [MergeOverlappingSubintervals.java](src/com/example/arrays2/MergeOverlappingSubintervals.java) | O(n log n) time, O(n) space |
...
| 7 | Minimum Coins (Tabulation / DP) | [MinimumCoinsTabulation.java](src/com/example/greedyalgorithm/MinimumCoinsTabulation.java) | O(n * amount) time, O(n * amount) space |
...
| 5 | Median of Two Sorted Arrays | [MedianOfTwoSortedArrays.java](src/com/example/binarysearch/MedianOfTwoSortedArrays.java) | O(m + n) time, O(1) space |
| 6 | Median of Two Sorted Arrays (Binary Search) | [MedianOfTwoSortedArraysBinarySearch.java](src/com/example/binarysearch/MedianOfTwoSortedArraysBinarySearch.java) | O(log(min(m, n))) time, O(1) space |
...
└── com/example/
    ...
    │   └── MergeOverlappingSubintervals.java
    ├── linkedlist1/
    │   ├── ListNode.java
    ...
    └── binarysearch/
        ...
        └── MedianOfTwoSortedArraysBinarySearch.java
```
